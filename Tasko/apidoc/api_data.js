define({ "api": [
  ...
  {
    "type": "post",
    "url": "c1/SendCustomerNotification",
        ...
        "Error 4xx": [
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "RESPONSE_WRONG",
            "description": "<p>Response from web service isn't OK</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "v1/SendVendorNotification",
    "title": "Send Vendor Notification",
    "name": "SendVendorNotification",
    "group": "Vendor",
    "header": {
      "fields": {
        "Header": [
