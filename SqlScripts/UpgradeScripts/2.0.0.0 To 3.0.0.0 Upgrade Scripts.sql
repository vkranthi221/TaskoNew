...
ALTER TABLE [VENDOR] ADD IS_VISIBLE_TO_ENTIRE_CITY bit
GO
 UPDATE [VENDOR] SET IS_VISIBLE_TO_ENTIRE_CITY = 0
GO
...
SET NOCOUNT ON;
	...
	dbo.[GetVendorTotalRating](V.VENDOR_ID) AS OVERALL_RATINGS,V.FACEBOOK_URL,V.PHOTO, V.MOBILE_NUMBER, V.IS_VISIBLE_TO_ENTIRE_CITY,A.CITY		
